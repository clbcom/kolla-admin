<header class="box-border bg-transparent flex flex-row items-center justify-between border-b-solid border-b-[rgba(0,0,0,0.1)] shadow-sm border-b text-xl font-bold">
