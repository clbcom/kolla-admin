        ...
        <div class="w-1/3 p-5 backdrop-blur-lg rounded-2xl border overflow-hidden text-lg">
            ...
            <form wire:submit.prevent="registrar">
                ...
                <div class="p-5 flex flex-col">
                    <label class="text-white text-xl" for="nombres">Nombres</label>
                    <input
                        class="p-3 rounded-full bg-transparent border outline-none focus-within:border-amber-400 text-amber-50"
                        type="text" id="nombres" wire:model="nombres" required>
                    @error('nombres')
                        <span class="pl-5 text-lg text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                <div class="p-5 flex flex-col">
                    <label class="text-white text-xl" for="paterno">Apellido paterno</label>
                    <input
                        class="p-3 rounded-full bg-transparent border outline-none focus-within:border-amber-400 text-amber-50"
                        type="text" id="paterno" wire:model="paterno" required>
                    @error('paterno')
                        <span class="pl-5 text-lg text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                <div class="p-5 flex flex-col">
                    <label class="text-white text-xl" for="materno">Apellido materno</label>
                    <input
                        class="p-3 rounded-full bg-transparent border outline-none focus-within:border-amber-400 text-amber-50"
                        type="text" id="materno" wire:model="materno" required>
                    @error('materno')
                        <span class="pl-5 text-lg text-red-500">{{ $message }}</span>
                    @enderror
                </div>
